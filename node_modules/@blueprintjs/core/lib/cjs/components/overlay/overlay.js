...
var Overlay = /** @class */ (function (_super) {
    ...
    function Overlay(props, context) {
        ...
        _this.maybeRenderChild = function (child) {
            ...
            var _a = _this.props, transitionDuration = _a.transitionDuration, transitionName = _a.transitionName;
    ...
    Overlay.prototype.render = function () {
        ...
        if (usePortal) {
            return React.createElement(portal_1.Portal, { onChildrenMount: this.handleContentMount }, transitionGroup);
        }
        else {
